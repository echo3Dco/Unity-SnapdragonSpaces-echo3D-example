...
namespace Qualcomm.Snapdragon.Spaces.Samples
{
    public class HandTrackingSampleController : SampleController
    {
        ...
        private GameObject MirroredPlayer;
        private GameObject MirroredPlayerHead;
        private GameObject MirroredJointObject;
        ...
        public override void Update() {
            if (Mirror != null && MirroredPlayer != null && MirroredPlayerHead != null && MirroredJointObject != null)
            {
                base.Update();
            ...
            if (Mirror == null)
            {
                Mirror = GameObject.Find("Mirror.glb/Mirror");
            }
            if (MirroredPlayer == null)
            {
                MirroredPlayer = GameObject.Find("Player.glb/Player");
            }
            if (MirroredPlayerHead == null)
            {
                MirroredPlayerHead = GameObject.Find("Player.glb/Player/Head");
            }
            if (MirroredJointObject == null)
            {
                MirroredJointObject = GameObject.Find("Player.glb/Player/Joint");
            }
            if (MirroredJointObject != null && _leftMirroredHandJoints == null)
            {
                _leftMirroredHandJoints = CreateHandJoints();
            }
            if (MirroredJointObject != null && _rightMirroredHandJoints == null)
            {
